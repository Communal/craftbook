  ...
  args: {
    children: (
      <>
        ...
        totam. A, facere cum porro distinctio ad neque sapiente iste deserunt
        eius est, pariatur voluptatibus excepturi dignissimos consequatur
        necessitatibus. Delectus blanditiis quia magnam eveniet aspernatur,
        alias officia quam esse consectetur culpa neque.
      </>
    ),
    withHeader: true,
    title: 'Dummy Title',
