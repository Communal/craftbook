...
import { CircleUserRound, MessageCircleDashed, Settings, ShieldCheck } from "lucide-react";

export default function SidebarMenuExample() {
  return (
    <SidebarMenuContainer>
      <SidebarMenu trigger="Account Settings" icon={<CircleUserRound className="w-4 h-4" />}>
        <SidebarMenuContent>
          ...
          <SidebarSubMenu trigger="Posts and Initiatives" icon={<MessageCircleDashed className="w-4 h-4" />}>
            <SidebarSubMenuContent>
              <SidebarSubMenuItem>Hide posts from members</SidebarSubMenuItem>
              <SidebarSubMenuItem>Hide initiatives from members</SidebarSubMenuItem>
            </SidebarSubMenuContent>
          </SidebarSubMenu>
        </SidebarMenuContent>
      </SidebarMenu>
      <SidebarMenu trigger="Community Settings" icon={<Settings className="w-4 h-4" />}>
        <SidebarMenuContent>
      ...
      <SidebarMenu trigger="Security" icon={<ShieldCheck className="w-4 h-4" />}>
        <SidebarMenuContent>
